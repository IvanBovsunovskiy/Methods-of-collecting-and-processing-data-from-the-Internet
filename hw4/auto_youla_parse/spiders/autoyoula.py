...
class AutoyoulaSpider(scrapy.Spider):
    ...
    data_query = {
        ...
        "photos": lambda resp: [
            itm.attrib.get("src") for itm in resp.css(
                "figure.PhotoGallery_photo__36e_r img.PhotoGallery_photoImage__2mHGn"
            )
        ],
        "characteristics": lambda resp: [
            {
                "chr_type": itm.css(".AdvertSpecs_label__2JHnS::text").extract_first(),
                "chr_value": itm.css(".AdvertSpecs_data__xK2Qx::text").extract_first()
