...
import datetime
import json
from ..items import ParseInstagramItem, ParsePostItem
from ..loaders import InstagramTagLoader, InstagramPostLoader


class InstagramSpider(scrapy.Spider):
    name = "instagram"
    allowed_domains = ["www.instagram.com", "i.instagram.com", "*.instagram.com", "*.i.instagram.com "]
    ...
    ig_app_id = '936619743392459' # access_token: 936619743392459|3cdb3f896252a1db29679cb4554db266
    ...
    def parse(self, response, *args, **kwargs):
        try:
            ...
            yield scrapy.FormRequest(
                ...
                headers={"X-CSRFToken": js_data["config"]["csrf_token"]},  # wg3Va212TrsVNethfW3uFlFJqAAzhKpY
            )
    ...
    def tag_page_parse(self, response):
        ...
        item = ParseInstagramItem()
        tag_loader = InstagramTagLoader(item=item)
    ...
    def post_parse(self, pagination, token, tag_name, type_post):
        sections = pagination.pop('sections')
        for section in sections:
            for media in section['layout_content']['medias']:
                ...
                item = ParsePostItem()
                post_loader = InstagramPostLoader(item=item)
